...
def main():	
    ...
    img_points = np.zeros((len(canny), len(canny[0])))
    img_points[points[0][1], points[0][0]] = 255
    img_points[points[1][1], points[1][0]] = 255
    img_points[points[2][1], points[2][0]] = 255
    chull = convex_hull_image(img_points)
    img_points[chull] = 255
    plt.imshow(img_points, cmap = 'gray')
    plt.show()
